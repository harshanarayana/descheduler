...
func NewDeschedulerCommand(out io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			tracerProvider, err := tracing.NewTracerProvider(s.Tracing.CollectorEndpoint, s.Tracing.TransportCert, s.Tracing.ServiceName, s.Tracing.Namespace, s.Tracing.SampleRate)
			if err != nil {
