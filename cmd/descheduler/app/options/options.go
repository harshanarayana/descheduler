...
func (rs *DeschedulerServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&rs.Tracing.Namespace, "otel-namespace", "", "OTEL Trace namespace to be used with the resources")
	fs.Float64Var(&rs.Tracing.SampleRate, "otel-sample-rate", 1.0, "OTEL Trace sampling rate")
